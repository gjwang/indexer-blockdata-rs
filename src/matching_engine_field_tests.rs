...
mod balance_field_tests {
    ...
    fn test_balance_fields_multiple_deposits() {
        ...
        // Second deposit
        engine.ledger.apply(&LedgerCommand::Deposit { user_id: 1, asset_id: 200, amount: 30000, balance_after: 0, version: 0 }).unwrap();
        ...
        // Third deposit
        engine.ledger.apply(&LedgerCommand::Deposit { user_id: 1, asset_id: 200, amount: 20000, balance_after: 0, version: 0 }).unwrap();
