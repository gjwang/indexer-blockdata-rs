...
fn main() {
    ...
    println!("  Throughput: {:.2} million ops/sec", iterations as f64 / duration_128.as_secs_f64() / 1_000_000.0);

    println!("FastUlidHalfGen (u64):");
    println!("  Total Time: {:?}", duration_64);
    println!("  Throughput: {:.2} million ops/sec", iterations as f64 / duration_64.as_secs_f64() / 1_000_000.0);
