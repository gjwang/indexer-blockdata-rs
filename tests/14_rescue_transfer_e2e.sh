...
# Note: we should ensure they pick up correct Kafka port too, via config or env.
# Assuming dev.yaml is used by default or config loading handles it.
...
export KAFKA_GROUP_ID="settlement_group_$(date +%s)"
